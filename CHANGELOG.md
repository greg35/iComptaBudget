...
### Corrigé
- Amélioration de la robustesse du chargement des projets : l'application peut désormais lire la liste des projets même si la migration de la base de données (colonne 'archived') a échoué ou n'a pas encore été appliquée.
...
### Corrigé
- Correction de la création du dossier de sauvegarde lors de l'importation.
- Amélioration de la gestion des erreurs lors de l'upload de sauvegarde.
...
### Corrigé
Fix authentification sur les API 
Correction bugs

## [1.7.0] - 2025-09-06

### Ajouté
- Ajout gestion d'un login / mot de passe pour protéger les données & API.
...
### Corrigé
- backend non accessible dans docker
